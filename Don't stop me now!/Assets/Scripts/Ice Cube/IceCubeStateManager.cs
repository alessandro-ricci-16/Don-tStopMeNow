...
[RequireComponent(typeof(IceCubeInput))]
public class IceCubeStateManager : MonoBehaviour
{
    ...
    private IceCubeParameters _parameters;
    ...
    public void InitStateManager(PlayerInputAction playerInputAction, IceCubeParameters parameters)
    {
